...
@section('main')
<div class="background" style="background-image: url('img/bg-signin.jpg')">
    ...
    <div class="col-sm-4">
        ...
        @endif
    <main class="form-signin shadow p-4 mt-5">
        <h1 class="h3 mb-3 fw-semibold text-center">Login</h1>
